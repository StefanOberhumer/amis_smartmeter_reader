...
#if 0
    AES128_CBC_decrypt_buffer(decrypted_ptr,    &encryptedSndUD->encryptedData[0],  16, nullptr, initialVector);
    yield();
...
#else
    /*
    _key wurde schon in setKey() an die AES128_set_key(_key) "weitergereicht"
